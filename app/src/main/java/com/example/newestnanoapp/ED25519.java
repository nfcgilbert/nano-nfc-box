 ...
 * 
 * - thanks k3d3!, note to anyone reading: the only change in this class is the digest method: H(byte[])... and I believe I don't even use it anymore.
 * This entire class may be useless for this project.
 */
